    ...
    h.cors = !!Gt && "withCredentials" in Gt, h.ajax = Gt = !!Gt, w.ajaxTransport(function (t) {
        ...
        if (h.cors || Gt && !t.crossDomain) return {
            send: function (i, o) {
                ...
                }, s.onload = n(), r = s.onerror = s.ontimeout = n("templates.error"), void 0 !== s.onabort ? s.onabort = r : s.onreadystatechange = function () {
            ...
            return {
                send: function (i, o) {
                    t = w("<script>").prop({charset: e.scriptCharset, src: e.url}).on("load error", n = function (e) {
                        t.remove(), n = null, e && o("templates.error" === e.type ? 404 : 200, e.type)
